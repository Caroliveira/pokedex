<template>
  <div class="mt-10">
    <v-row v-for="el in about" :key="el.title">
      <v-col cols="4" class="body1-gray3"> {{ el.title }} </v-col>
      <v-col cols="8" class="body1-gray2"> {{ el.value }} </v-col>
    </v-row>
    <h2 class="h2-gray1 mt-10">Breeding</h2>
    <v-row>
      <v-col cols="4" class="body1-gray3"> Gender </v-col>
      <v-col v-if="hasGender" cols="8" class="body1-gray2 d-flex align-center">
        <div class="male mr-2" />
        <span> {{ male }} </span>
      ...
      <v-col cols="8" class="body1-gray2"> {{ pokemon.eggCycle }} </v-col>
    </v-row>
